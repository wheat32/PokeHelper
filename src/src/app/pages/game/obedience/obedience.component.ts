...
export class ObedienceComponent extends GamePageBase
{
  obedienceRows: ObedienceRow[] = [
    ...
    { badges: 1,  badgeName: 'Boulder Badge',   gymLeader: 'Brock',     city: 'Pewter City',     levelCap: 20,   isMilestone: true  },
    { badges: 2,  badgeName: 'Cascade Badge',   gymLeader: 'Misty',     city: 'Cerulean City',   levelCap: 30,   isMilestone: true  },
    { badges: 3,  badgeName: 'Thunder Badge',   gymLeader: 'Lt. Surge', city: 'Vermilion City',  levelCap: 40,   isMilestone: true  },
    { badges: 4,  badgeName: 'Rainbow Badge',   gymLeader: 'Erika',     city: 'Celadon City',    levelCap: 50,   isMilestone: true  },
    { badges: 5,  badgeName: 'Soul Badge',      gymLeader: 'Koga',      city: 'Fuchsia City',    levelCap: 70,   isMilestone: true  },
    { badges: 6,  badgeName: 'Marsh Badge',     gymLeader: 'Sabrina',   city: 'Saffron City',    levelCap: 70,   isMilestone: false },
